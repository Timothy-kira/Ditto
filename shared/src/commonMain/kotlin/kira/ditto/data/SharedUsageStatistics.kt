...
fun tokenCacheHitPercent(cachedInputTokens: Long, inputTokens: Long): Int? {
    val billed = cachedInputTokens + inputTokens
    if (billed <= 0L) return null
    return ((cachedInputTokens * 100.0) / billed).roundToInt().coerceIn(0, 100)
}
