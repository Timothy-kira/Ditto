...
class SharedUsageStatisticsTest {
    ...
    @Test
    fun cacheHitPercentUsesCachedShareOfBilledInput() {
        assertEquals(80, tokenCacheHitPercent(cachedInputTokens = 80, inputTokens = 20))
        assertEquals(null, tokenCacheHitPercent(cachedInputTokens = 0, inputTokens = 0))
        assertEquals(0, tokenCacheHitPercent(cachedInputTokens = 0, inputTokens = 40))
        assertEquals(100, tokenCacheHitPercent(cachedInputTokens = 12, inputTokens = 0))
    }
